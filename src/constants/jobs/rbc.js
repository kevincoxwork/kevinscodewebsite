export const RBC2021 = {
    ...
    jobDesc: [
        ...
        'Preventive controls audited requested resources and its accompanying AWS CloudFormation resource structure',
        'Detective controls periodically analyzed provisioned resources through python boto3 libraries and Amazon CDK',
    ],
  };