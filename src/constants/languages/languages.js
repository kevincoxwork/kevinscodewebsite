...
export const Database = {
  languagesTitle: 'Databases',
  languages: 'SQL Server, Redis, MySQL, MongoDB, Oracle DB',
};
...
export const Testing = {
  languagesTitle: 'Testing',
  languages: 'Mocha, Chai, Jest, Puppeteer, Selenium, WebDriver.io',
};
